...
<template>
  <section ref="elRef" class="boom-section">
    ...
    <div class="boom-wrap" :style="{ opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(24px)', transition: 'all 0.6s cubic-bezier(0.23,1,0.32,1) 0.1s' }">
      <div class="boom-flex-center">
        <!-- Phone -->
        <div class="phone-mockup">
          <div style="height: 12px" />
          <!-- Header with SharkEyes SVG -->
          ...
          <div class="phone-card">
            ...
            <div style="font-family: var(--font-body); font-size: 10px; color: #fff; margin-bottom: 6px; font-weight: 600">
              Баланс: <span style="font-family: var(--font-mono); font-weight: 700">1 200 ₽</span>
            </div>
          ...
          <div class="phone-progress">
            ...
            <div class="progress-track">
              <div class="progress-fill"><div class="progress-stripes" /></div>
            </div>
          </div>
          <!-- Nav tabs with SVG icons -->
          <div style="display: flex; gap: 6px; margin: 8px 12px 0; position: relative; z-index: 1">
            <div class="phone-tab">
              <span style="color: var(--yellow)"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 14.66v1.63a2 2 0 0 1-.98 1.7A5 5 0 0 0 7 21.98"/><path d="M14 14.66v1.63a2 2 0 0 0 .98 1.7A5 5 0 0 1 17 21.98"/><path d="M18 9h1.5a1 1 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M6 9a6 6 0 0 0 12 0V3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1z"/><path d="M6 9H4.5a1 1 0 0 1 0-5H6"/></svg></span>
              <span class="phone-tab-label">Призы</span>
            </div>
            <div class="phone-tab">
              <span style="color: var(--cyan)"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M12 7v5l4 2"/></svg></span>
              <span class="phone-tab-label">История</span>
            </div>
            <div class="phone-tab">
              <span style="color: var(--green)"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="12" cy="10" r="3"/><path d="M7 21v-2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2"/></svg></span>
              <span class="phone-tab-label">Профиль</span>
            </div>
          </div>
          <!-- SharkEyes watermark -->
        ...
        <div style="flex: 1; min-width: 240px">
          <div style="margin-bottom: 24px">
            <div v-for="(f, i) in feats" :key="i" style="display: flex; gap: 12px; margin-bottom: 18px; align-items: flex-start">
              <span style="flex-shrink: 0; margin-top: 4px">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="var(--lime)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8v8"/><path d="M2.7 10.3a2.41 2.41 0 0 0 0 3.41l7.59 7.59a2.41 2.41 0 0 0 3.41 0l7.59-7.59a2.41 2.41 0 0 0 0-3.41L13.7 2.71a2.41 2.41 0 0 0-3.41 0z"/><path d="M8 12h8"/></svg>
              </span>
              <div>
...
.progress-stripes {
  ...
  background-image: repeating-linear-gradient(110deg, rgba(255,255,255,0.15) 0px, rgba(255,255,255,0.15) 4px, transparent 4px, transparent 10px);
  background-size: 20px 100%; animation: progressStripes 0.8s linear infinite;
}
.phone-tab {
