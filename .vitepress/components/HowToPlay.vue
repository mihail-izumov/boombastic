...
const steps = [
  ...
  /* ⚠ Курс правился 24.08.2026. Было «1 заряд = 10₽» — ошибка: при таком
     курсе пакет «500₽ → 625 зарядов» на странице /charge означал бы наценку
     в 1150%. Базовый курс 1:1, проценты сверху — это бонусные заряды.
     Меняешь цифру — проверь ChargeCardPage.vue и FAQ.vue, там те же числа. */
  { num: '02', title: 'Пополни заряды', desc: 'На кассе или онлайн. 1 заряд = 1₽, игра — 33–100 зарядов', color: 'var(--orange)' },
