  ...
  <Teleport to="body">
    <div style="position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;pointer-events:none;">
      ...
      <div :style="{position:'relative',zIndex:1,textAlign:'center',width:'100%',padding:'0 12px',opacity:phase>=1?1:0,transform:phase>=1?'scale(1) translateY(0)':'scale(0.5) translateY(30px)',transition:'all 0.8s cubic-bezier(0.22,1,0.36,1)'}">
        <div style="font-size:clamp(30px,7vw,72px);color:#FFD60A;letter-spacing:-1px;font-family:'Space Mono',monospace;font-weight:700;white-space:nowrap;display:inline-flex;align-items:baseline;line-height:1.5;padding:8px 0;">
          <span style="text-shadow:0 0 20px #FFD60A, 0 0 60px rgba(255,214,10,0.5), 0 0 100px rgba(255,214,10,0.25);">Б</span>
          <span style="text-shadow:0 0 20px #FFD60A, 0 0 60px rgba(255,214,10,0.5), 0 0 100px rgba(255,214,10,0.25);">00</span>
          <span :style="{display:'inline-block',overflow:'hidden',verticalAlign:'baseline',lineHeight:'inherit',maxWidth:phase>=2&&phase<3?'5em':'0',transition:phase>=2?'max-width 0.8s ease-in-out':'max-width 0.6s ease-in-out',textShadow:'none'}">0000000</span>
          <span style="text-shadow:0 0 20px #FFD60A, 0 0 60px rgba(255,214,10,0.5), 0 0 100px rgba(255,214,10,0.25);">М!</span>
        </div>
