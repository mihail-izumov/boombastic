  ...
  <Teleport to="body">
    <div style="position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;pointer-events:none;">
      ...
      <div :style="{position:'relative',zIndex:1,textAlign:'center',width:'100%',padding:'0 20px',opacity:phase>=1?1:0,transform:phase>=1?'scale(1) translateY(0)':'scale(0.5) translateY(30px)',transition:'all 0.8s cubic-bezier(0.22,1,0.36,1)'}">
        <div style="filter:drop-shadow(0 0 18px #FFD60A) drop-shadow(0 0 50px rgba(255,214,10,0.55));overflow:visible;padding:20px 0;">
          <div style="font-size:clamp(36px,8vw,80px);color:#FFD60A;letter-spacing:-2px;font-family:'Space Mono',monospace;font-weight:700;white-space:nowrap;display:inline-flex;align-items:baseline;overflow:visible;line-height:1.3;">
        ...
        <div style="font-size:18px;color:#FFD60A;margin-top:12px;font-family:'Inter',sans-serif;font-weight:700;text-shadow:0 0 20px rgba(255,214,10,0.6),0 0 40px rgba(255,214,10,0.3);letter-spacing:0.05em;">Лови приз!</div>
      </div>
    </div>
  </Teleport>
</template>
