...
const parks = [
  {
    ...
    topMachines: ['Big Bass Wheel', 'Monster Drop CHAOS', 'Funky Box'],
    nearby: ['Todes', 'Joki Joya', 'КИНО-5D', 'MIR VR'],
    tagColor: '#FF0080',
    accent: '#FF0080',
    shortDesc: 'Максимум выбора игр и призов. Конкуренция в каждом углу.',
  ...
  },
  {
    ...
    topMachines: ['Big Bass Wheel', 'Big Win Super Spin', 'Triple turn'],
    nearby: ['Аквапарк', 'Отель', 'Фудкорт'],
    tagColor: '#00FF88',
    accent: '#00FF88',
    shortDesc: 'Курортная арена. Аквапарк и отель рядом.',
    fullDesc: 'Своя игровая вселенная. Аквапарк и отель рядом — семьи совмещают визиты. Pump It Up притягивает фанатов танцевальных аркад со всего города.',
    glowColor1: 'rgba(0,255,136,0.06)',
  ...
  },
  {
    ...
    tagColor: '#FFD60A',
    accent: '#FFD60A',
    shortDesc: 'Самый большой парк БумБастик. Максимум автоматов.',
