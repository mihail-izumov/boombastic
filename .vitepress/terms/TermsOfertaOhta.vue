<template>
  <div class="terms-doc">
    ...
    <div class="doc-header">
      ...
      <p class="doc-meta">Редакция от 19 сентября 2026 г. · ИП Завернин Эдуард Игоревич · Охта Молл</p>
    </div>
...
const sections = [
  { title: 'Термины и определения', html: `<p><b>Исполнитель</b> — ИП Завернин Эдуард Игоревич (ИНН 290217217403, ОГРНИП 304290201600071).</p><p><b>Заказчик (Посетитель)</b> — любой человек, пользующийся услугами парка.</p><p><b>Парк</b> — «Бумбастик» в ТРК «Охта Молл», этаж 3, оф. 3.15, Братиславская дорога, д. 3.</p><p><b>Игровая карта</b> — пластиковая карта с чипом, носитель кредитов для запуска автоматов.</p><p><b>Игровые единицы (кредиты)</b> — условные единицы в рублях, списываемые за каждую игру.</p><p><b>Личный кабинет</b> — lk.b00m.fun.</p><p><b>Акцепт оферты</b> — согласие с условиями договора путём любого действия из п. 2.3.</p>` },
  { title: 'Предмет договора и акцепт', html: `<p>Исполнитель предоставляет доступ к игровому оборудованию, Заказчик оплачивает услуги.</p><p><b>Договор считается заключённым</b> при любом из действий:</p><ul><li>оплата или пополнение карты онлайн или на кассе;</li><li>регистрация в Личном кабинете;</li><li>фактическое использование автомата.</li></ul><p>Принимая оферту, Заказчик подтверждает ознакомление с условиями и Политикой конфиденциальности (b00m.fun/terms/policy).</p>` },
  { title: 'Правила посещения парка', html: `<p><b>Режим работы:</b> ежедневно с 10:00 до 22:00.</p><p><b>Дети до 14 лет</b> допускаются только со взрослым от 18 лет.</p><p><b>Вход в парк бесплатный.</b></p><p><b>На территории парка запрещено:</b></p><ul><li>алкогольное или наркотическое опьянение;</li><li>курение, вейпы;</li><li>еда и напитки (детское питание — исключение);</li><li>физическое воздействие на автоматы;</li><li>агрессия по отношению к посетителям.</li></ul>` },
  { title: 'Карты, тарифы и оплата', html: `<p><b>Получение карты:</b> на кассе или онлайн в Личном кабинете.</p><p><b>Бонусы:</b> при пополнении от 3 000 ₽ — бонусные кредиты согласно акции.</p><p><b>Тарифы</b> на каждый автомат указаны на нём самом.</p><p><b>Неиспользованные кредиты не сгорают.</b></p><p>Приём платежей через ЮKassa (ООО «НКО ЮМани»).</p>` },
  { title: 'Возврат денежных средств', html: `<p><b>Срок подачи заявки:</b> не позднее 3 рабочих дней.</p><ul><li>лично на кассе с документом, удостоверяющим личность;</li><li>по email: spb@bumbastiki.ru.</li></ul><p><b>Срок возврата:</b> 10 рабочих дней. Бонусные кредиты возврату не подлежат.</p>` },
  { title: 'Права и обязанности сторон', html: `<p><b>Исполнитель обязуется:</b></p><ul><li>обеспечить доступ к исправному оборудованию;</li><li>не передавать данные третьим лицам (кроме платёжной системы);</li><li>рассматривать претензии в течение 10 рабочих дней.</li></ul><p><b>Заказчик обязуется:</b></p><ul><li>соблюдать правила парка и использования оборудования;</li><li>предоставлять достоверные данные при регистрации.</li></ul>` },
  { title: 'Персональные данные', html: `<p>Обработка согласно ФЗ № 152-ФЗ «О персональных данных».</p><p>Полный порядок — в Политике конфиденциальности: <b>b00m.fun/terms/policy</b></p><p>Данные передаются только платёжной системе ЮKassa.</p>` },
  { title: 'Ответственность и разрешение споров', html: `<p>Исполнитель не несёт ответственности за форс-мажор.</p><p><b>Претензионный порядок обязателен.</b> Срок ответа — 10 рабочих дней.</p>` },
  { title: 'Срок действия и изменения', html: `<p>Договор действует бессрочно с момента публикации. Изменения вступают в силу с момента публикации на сайте.</p>` },
  { title: 'Реквизиты исполнителя', html: `<div class="requisites"><p><b>ИП Завернин Эдуард Игоревич</b></p><p>ОГРНИП: 304290201600071 · ИНН: 290217217403</p><p>Р/с: 40802810855000094626 · ПАО Сбербанк · БИК: 044030653</p><br><p>Братиславская дорога, д. 3, ТРК «Охта Молл», этаж 3, оф. 3.15</p><p>Телефон: +7 (964) 321-11-00 · Email: spb@bumbastiki.ru</p></div>` },
]
</script>

<style scoped>
/* Охта Молл accent = #FF0080 */
:root { --park: #FF0080; }
...
.section.open { border-color: rgba(255,0,128,0.3); }
