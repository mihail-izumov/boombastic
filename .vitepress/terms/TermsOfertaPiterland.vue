<template>
  <div class="terms-doc">
    ...
    <div class="doc-header">
      ...
      <p class="doc-meta">Редакция от 19 сентября 2026 г. · ИП Ендовицкий Олег Сергеевич · Питерлэнд</p>
    </div>
...
const sections = [
  { title: 'Термины и определения', html: `<p><b>Исполнитель</b> — ИП Ендовицкий Олег Сергеевич (ИНН 290201263531, ОГРНИП 307290205900016).</p><p><b>Заказчик (Посетитель)</b> — любой человек, пользующийся услугами парка.</p><p><b>Парк</b> — «Бумбастик» в ТРК «Питерлэнд», Приморский проспект, д. 72.</p><p><b>Игровая карта</b> — пластиковая карта с чипом, носитель кредитов.</p><p><b>Личный кабинет</b> — lk.b00m.fun.</p>` },
  ...
  { title: 'Реквизиты исполнителя', html: `<div class="requisites"><p><b>ИП Ендовицкий Олег Сергеевич</b></p><p>ОГРНИП: 307290205900016 · ИНН: 290201263531</p><p>197374, г. Санкт-Петербург, Приморский проспект, д. 72, литера А, пом. 332</p><br><p>ТРК «Питерлэнд», Приморский проспект, д. 72</p><p>Телефон: +7 (965) 045-75-55 · Email: spb@bumbastiki.ru</p></div>` },
]
</script>
