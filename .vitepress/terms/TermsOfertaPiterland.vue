...
const sections = [
  { title: 'Термины и определения', html: `<p><b>Исполнитель</b> — ИП Завернин Лев Эдуардович (ИНН 290218807250, ОГРНИП 325290000025349).</p><p><b>Заказчик (Посетитель)</b> — любой человек, пользующийся услугами парка.</p><p><b>Парк</b> — «Бумбастик» в ТРК «Питерлэнд», Приморский проспект, д. 72.</p><p><b>Игровая карта</b> — пластиковая карта с чипом, носитель кредитов для запуска автоматов.</p><p><b>Игровые единицы (кредиты)</b> — условные единицы в рублях, списываемые за каждую игру.</p><p><b>Личный кабинет</b> — lk.b00m.fun.</p><p><b>Акцепт оферты</b> — согласие с условиями договора путём любого действия из п. 2.3.</p>` },
  ...
  { title: 'Правила посещения парка', html: `<p><b>Дети до 14 лет</b> допускаются только со взрослым от 18 лет.</p><p><b>Вход в парк бесплатный.</b> Оплачивается только карта и кредиты.</p><p><b>На территории парка запрещено:</b></p><ul><li>алкогольное или наркотическое опьянение;</li><li>курение, вейпы;</li><li>еда и напитки (детское питание — исключение);</li><li>физическое воздействие на автоматы;</li><li>агрессия по отношению к посетителям.</li></ul>` },
  { title: 'Карты, тарифы и оплата', html: `<p><b>Получение карты:</b> на кассе или онлайн в Личном кабинете.</p><p><b>Бонусы:</b> при пополнении от 3 000 ₽.</p><p><b>Тарифы</b> на каждый автомат указаны на нём самом.</p><p><b>Неиспользованные кредиты не сгорают.</b></p><p>Приём платежей — через ЮKassa (ООО «НКО ЮМани»).</p>` },
  ...
  { title: 'Персональные данные', html: `<p>Обработка согласно ФЗ № 152-ФЗ «О персональных данных».</p><p>Полный порядок — в Политике: <b>b00m.fun/terms/policy</b>. Данные передаются только ЮKassa.</p>` },
  ...
  { title: 'Реквизиты исполнителя', html: `<div class="requisites"><p><b>ИП Завернин Лев Эдуардович</b></p><p>ОГРНИП: 325290000025349 · ИНН: 290218807250</p><p>г. Санкт-Петербург, Приморский проспект, д. 72, лит. А</p><br><p>ТРК «Питерлэнд», Приморский проспект, д. 72</p><p>Телефон: +7 (965) 045-75-55</p><p>Email: spb@bumbastiki.ru</p></div>` },
]
</script>
...
.section.open { border-color: rgba(0,212,255,0.25); }
...
.section-toggle:hover { background: rgba(0,212,255,0.05); }
