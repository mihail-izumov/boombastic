<template>
  <div class="terms-doc">
    ...
    <div class="doc-header">
      ...
      <p class="doc-meta">Редакция от 19 сентября 2026 г.</p>
    </div>
...
const tldr = [
  ...
  { title: 'Отзыв в любой момент',     text: 'Email spb@bumbastiki.ru или лично — прекратим за 30 дней',     mask: ic(`<path d="M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16"/><path d="M16 16h5v5"/>`) },
...
const sections = [
  { title: 'Кто даёт согласие и кому', html: `<p>Регистрируясь или оплачивая, ты даёшь согласие Операторам:</p><ul><li><b>ИП Завернин Эдуард Игоревич</b> (ИНН 290217217403) — Охта Молл и Июнь;</li><li><b>ИП Ендовицкий Олег Сергеевич</b> (ИНН 290201263531) — Питерлэнд.</li></ul>` },
  ...
  { title: 'Для чего используются данные', html: `<ul><li>Регистрация и авторизация в Личном кабинете;</li><li>исполнение договора публичной оферты;</li><li>обработка платежей через ЮKassa;</li><li>уведомления об изменениях в работе парков;</li><li>рекламные рассылки — только при отдельном согласии;</li><li>исполнение требований закона.</li></ul>` },
  { title: 'Способы обработки', html: `<p>Сбор, запись, систематизация, хранение, уточнение, передача (согласно п. 5), блокирование, удаление. Обработка ведётся автоматически и вручную.</p>` },
  { title: 'Кому передаются данные', html: `<ul><li><b>ЮKassa</b> — для онлайн-платежей;</li><li><b>Яндекс.Метрика</b> — обезличенные данные;</li><li><b>Хостинг-провайдеры</b> — для работы сайта;</li><li><b>Государственные органы</b> — только по требованию закона.</li></ul><p>Продажа данных не осуществляется.</p>` },
  { title: 'Срок действия согласия', html: `<p>Согласие действует до отзыва или достижения целей обработки. Сроки хранения — в Политике: b00m.fun/terms/policy</p>` },
  ...
  { title: 'Права пользователя', html: `<ul><li>Получать информацию об обработке;</li><li>требовать исправления, блокирования или удаления;</li><li>отозвать согласие в любой момент;</li><li>обжаловать в Роскомнадзор или суд.</li></ul><p>Полный перечень — в Политике: <b>b00m.fun/terms/policy</b></p>` },
  { title: 'Заключительные положения', html: `<p>Регистрируясь или оплачивая, ты подтверждаешь, что:</p><ul><li>ознакомлен с Согласием и Политикой конфиденциальности;</li><li>действуешь добровольно;</li><li>достиг 18 лет, либо действуешь с согласия законного представителя.</li></ul>` },
...
<style scoped>
/* Согласие accent = #00FF88 (green — не цвет парка) */
...
.section.open { border-color: rgba(0,255,136,0.3); }
