...
const sections = [
  { title: 'Кто даёт согласие и кому', html: `<p>Регистрируясь или оплачивая, ты даёшь согласие Операторам:</p><ul><li><b>ИП Завернин Эдуард Игоревич</b> (ИНН 290217217403) — Охта Молл;</li><li><b>ИП Ендовицкий Олег Сергеевич</b> (ИНН 290201263531) — Питерлэнд.</li></ul>` },
