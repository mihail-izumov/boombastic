...
const sections = [
  { title: 'Общие положения', html: `<p>Политика устанавливает порядок обработки персональных данных посетителей b00m.fun и парков «Бумбастик».</p><p><b>Операторы:</b></p><ul><li>ИП Завернин Эдуард Игоревич (ИНН 290217217403) — Охта Молл и Июнь;</li><li>ИП Ендовицкий Олег Сергеевич (ИНН 290201263531) — Питерлэнд.</li></ul>` },
  { title: 'Какие данные обрабатываются', html: `<p><b>При регистрации:</b> ФИО, номер телефона, email, дата рождения.</p><p><b>При использовании карты:</b> номер, баланс, история транзакций.</p><p><b>Технически:</b> IP-адрес, cookies, данные браузера (Яндекс.Метрика).</p>` },
  { title: 'Для чего используются данные', html: `<ul><li>Регистрация и авторизация в Личном кабинете.</li><li>Управление картой и обработка платежей через ЮKassa.</li><li>Уведомления об изменениях в работе парков.</li><li>Рекламные рассылки — только с отдельного согласия.</li><li>Улучшение сайта и исполнение требований закона.</li></ul>` },
  { title: 'Правовые основания обработки', html: `<ul><li>ФЗ № 152-ФЗ «О персональных данных»;</li><li>согласие субъекта (ст. 9 ФЗ-152);</li><li>необходимость исполнения договора;</li><li>законные интересы Оператора.</li></ul>` },
  { title: 'Способы и сроки обработки', html: `<p>Автоматически и вручную согласно законодательству.</p><p><b>Сроки хранения:</b></p><ul><li>Данные Личного кабинета — до удаления или отзыва согласия;</li><li>Данные транзакций — 5 лет;</li><li>Технические логи — 1 год.</li></ul>` },
  { title: 'Передача данных третьим лицам', html: `<ul><li><b>ЮKassa</b> — для обработки онлайн-платежей;</li><li><b>Яндекс.Метрика</b> — обезличенные данные;</li><li><b>Хостинг-провайдеры</b> — для хранения данных;</li><li><b>Государственные органы</b> — только по требованию закона.</li></ul><p>Продажа данных третьим лицам не осуществляется.</p>` },
  ...
  { title: 'Защита данных', html: `<ul><li>Шифрование SSL/TLS;</li><li>ограниченный доступ сотрудников;</li><li>регулярные проверки безопасности;</li><li>резервное копирование.</li></ul>` },
  ...
  { title: 'Изменения политики', html: `<p>Актуальная версия: <b>b00m.fun/terms/policy</b>. При существенных изменениях уведомим по email.</p>` },
...
<style scoped>
/* Политика accent = #C5F946 (lime — не цвет парка) */
...
.section.open { border-color: rgba(197,249,70,0.3); }
