 ...
 * Питерленд — ИП Завернин Л. Э.) и разные адреса. Общий текст на два юрлица
...
const RULES = {
  ...
  piterland: {
    ...
    blocks: rulesFor(
      ...
      '+7 (965) 045-75-55',
      'Индивидуальный предприниматель Завернин Лев Эдуардович, ИНН 290218807250, ОГРНИП 325290000025349, адрес: г. Санкт-Петербург, Приморский проспект, д. 72, лит. А'
    )
  },
  iyun: {
    org: 'ИП Завернин Э. И.',
